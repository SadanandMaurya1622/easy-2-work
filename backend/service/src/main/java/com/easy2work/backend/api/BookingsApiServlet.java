...
public class BookingsApiServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        try {
            List<Booking> all = fetch(req, key);
    ...
    private static Map<String, Object> toRow(Booking b) {
    ...
    private static List<Booking> fetch(HttpServletRequest req, String key10) throws Exception {
