...
public class AdminBookingsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            List<ServiceBooking> rows = load(req);
            ...
            req.getRequestDispatcher("/WEB-INF/jsp/admin-bookings.jsp").forward(req, resp);
        } catch (Exception e) {
    ...
    static String resolveExpectedSecret(ServletContext ctx) {
        ...
        if (ctx.getAttribute(DataSourceListener.CTX_DATASOURCE) == null) {
    ...
    private static boolean dataSourceConfigured(HttpServletRequest req) {
        return req.getServletContext().getAttribute(DataSourceListener.CTX_DATASOURCE) != null;
    }

    private static List<ServiceBooking> load(HttpServletRequest req) throws Exception {
