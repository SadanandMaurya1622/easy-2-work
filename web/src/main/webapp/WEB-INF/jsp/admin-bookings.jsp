  ...
  <div class="container-fluid py-4 px-3 px-md-4">
    ...
    <c:if test="${not empty adminDemoKeyHint}">
      <div class="alert alert-info py-2 small mb-3" role="status">
        ...
        Ek browser mein <a href="<%= c %>/book.jsp" class="alert-link">book.jsp</a> se booking karein,
        is page par <strong>Refresh</strong> — dono same server (in-memory) use karte hain.
      </div>
    </c:if>
